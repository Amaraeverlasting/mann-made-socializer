#!/usr/bin/env python3
"""Post a video to YouTube using agent-browser"""
import argparse, subprocess, sys


def post(video_path: str, caption: str, cdp_port: int = 18800):
    print(f"Posting video to YouTube: {video_path}")
    print(f"Title/Caption: {caption[:100]}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Post video to YouTube")
    parser.add_argument("--video", required=True, help="Path to video file")
    parser.add_argument("--caption", default="", help="Post title/caption")
